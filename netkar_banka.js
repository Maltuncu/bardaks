...
(function(){
  ...
  waitApp(function(){
    window.ysLoadUrunler = function(){
      ...
      window.ysSatirlar=fiyatlar.map(function(p){return {urun_id:p.urun_id,ad:p.urun_ad,fiyat:p.birim_fiyat_kdv_haric,kdv:p.kdv_orani,adet:0};}).concat(manuals);
      ysRenderSatirlar(); };
